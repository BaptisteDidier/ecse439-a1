...
/**
 * This is the item provider adapter for a {@link cps.Student} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StudentItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addMaxCreditsPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CpsPackage.Literals.STUDENT__NAME,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Max Credits feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addMaxCreditsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Student_maxCredits_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Student_maxCredits_feature", "_UI_Student_type"),
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CpsPackage.Literals.STUDENT__TAKEN);
			childrenFeatures.add(CpsPackage.Literals.STUDENT__PLANNED_SESSIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CpsPackage.Literals.STUDENT__TAKEN,
				 CpsFactory.eINSTANCE.createCourse()));

		newChildDescriptors.add
			(createChildParameter
				(CpsPackage.Literals.STUDENT__PLANNED_SESSIONS,
				 CpsFactory.eINSTANCE.createPlannedSession()));
	}
