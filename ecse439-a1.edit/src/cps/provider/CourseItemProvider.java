...
/**
 * This is the item provider adapter for a {@link cps.Course} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CourseItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addOfferedPropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CpsPackage.Literals.COURSE__CODE,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Offered feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addOfferedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Course_offered_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Course_offered_feature", "_UI_Course_type"),
				 CpsPackage.Literals.COURSE__OFFERED,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CpsPackage.Literals.COURSE__PREREQ);
			childrenFeatures.add(CpsPackage.Literals.COURSE__COREQ);
		}
	...
	public String getText(Object object) {
		String label = ((Course)object).getCode();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CpsPackage.Literals.COURSE__PREREQ,
		...
		newChildDescriptors.add
			(createChildParameter
				(CpsPackage.Literals.COURSE__COREQ,
				 CpsFactory.eINSTANCE.createExpr()));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == CpsPackage.Literals.COURSE__PREREQ ||
			childFeature == CpsPackage.Literals.COURSE__COREQ;
