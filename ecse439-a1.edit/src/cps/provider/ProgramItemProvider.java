...
/**
 * This is the item provider adapter for a {@link cps.Program} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProgramItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CpsPackage.Literals.PROGRAM__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CpsPackage.Literals.PROGRAM__COURSES);
			childrenFeatures.add(CpsPackage.Literals.PROGRAM__STUDENTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CpsPackage.Literals.PROGRAM__COURSES,
				 CpsFactory.eINSTANCE.createCourse()));

		newChildDescriptors.add
			(createChildParameter
				(CpsPackage.Literals.PROGRAM__STUDENTS,
				 CpsFactory.eINSTANCE.createStudent()));
	}
