...
public class CpsSyntacticSequencer extends AbstractSyntacticSequencer {

	protected CpsGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (CpsGrammarAccess) access;
	 ...
	 *     (rule start) (ambiguity) course=[Course|ID]
