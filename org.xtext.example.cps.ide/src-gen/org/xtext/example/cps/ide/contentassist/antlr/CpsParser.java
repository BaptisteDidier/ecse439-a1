...
public class CpsParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, CpsGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getCourseAccess().getCodeAssignment_1(), "rule__Course__CodeAssignment_1");
			builder.put(grammarAccess.getCourseAccess().getCreditsAssignment_3(), "rule__Course__CreditsAssignment_3");
			builder.put(grammarAccess.getCourseAccess().getOfferedAssignment_5(), "rule__Course__OfferedAssignment_5");
			builder.put(grammarAccess.getCourseAccess().getYearAssignment_7(), "rule__Course__YearAssignment_7");
			builder.put(grammarAccess.getCourseAccess().getPrereqAssignment_8_1(), "rule__Course__PrereqAssignment_8_1");
			builder.put(grammarAccess.getCourseAccess().getCoreqAssignment_9_1(), "rule__Course__CoreqAssignment_9_1");
